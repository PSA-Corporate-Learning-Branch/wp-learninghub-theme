    ...
    <div class="bg-secondary-subtle pt-4">
        <div class="container-lg p-lg-5 p-4 bg-light-subtle">
            <p class="fs-6">
                ...
                </span>Choose the list that applies to you. Click the heading to show or hide the content.
                <br><strong>Note:</strong> All course links open in a new tab or window.
            </p>
