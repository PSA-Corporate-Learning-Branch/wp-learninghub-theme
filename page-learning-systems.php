...
<div id="content">
    ...
    <div class="bg-secondary-subtle">
        <div class="container-lg p-lg-5 p-4 bg-light-subtle">
            ...
            <p class="mb-4">The LearningHUB is a directory of courses available to all BC Public Service employees. It includes courses from more than a dozen platforms.</p>
            <div class="row">
                <div class="col-md-6">
