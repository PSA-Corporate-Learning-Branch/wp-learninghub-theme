<span class="card shadow-sm rounded mb-2">
    <span class="card-body">
        <details>
            <summary class="fs-6 text-primary unstyled">
                <h4 class="coursename text-primary h5 mb-0"><?= the_title(); ?></h4>
                <h5 class="published d-none"><?= the_date(); ?></h5>
                <span class="d-flex flex-wrap align-items-center gap-3 mb-3 mt-2 fw-normal text-body-secondary" style="font-size: 0.75rem;">
                    <span title="Topic">
            ...
            <span class="coursedesc fs-6"><?php the_content(); ?></span>


            <?php if (!empty($post->mandatory_notes)) : ?>
                <span class="mandonotes" style="background-color: #fffede; border-radius: 5px; margin: 1em 0 0 0; padding: 1em;">
            ...
            <?php endif ?>
            <span class="mt-0 text-end" style="font-size: 0.75rem;">
                <a class="fw-normal text-decoration-none" href="<?= the_permalink() ?>">
                    <span class="icon-svg baseline-svg"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M6.354 5.5H4a3 3 0 0 0 0 6h3a3 3 0 0 0 2.83-4H9c-.086 0-.17.01-.25.031A2 2 0 0 1 7 10.5H4a2 2 0 1 1 0-4h1.535c.218-.376.495-.714.82-1z" />
                            <path d="M9 5.5a3 3 0 0 0-2.83 4h1.098A2 2 0 0 1 9 6.5h3a2 2 0 1 1 0 4h-1.535a4.02 4.02 0 0 1-.82 1H12a3 3 0 1 0 0-6H9z" />
                        </svg></span>Direct link to course page
                </a>
            </span>
            <span class="coursekeywords mt-1 d-none">
