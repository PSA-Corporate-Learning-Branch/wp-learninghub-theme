<div class="card shadow-sm rounded mb-2">
    <div class="card-body">
        <div style="transform: rotate(0);">
            ...
            <a class="fs-6 stretched-link" data-bs-toggle="collapse" href="#course-<?= get_the_ID() ?>" aria-expanded="false"
                aria-controls="course-<?= get_the_ID() ?>"><span class="summary">More info</span></a>
        </div>
        <div class="collapse" id="course-<?= get_the_ID() ?>">
