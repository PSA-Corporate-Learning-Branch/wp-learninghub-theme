                ...
                <div id="results" class="col-lg-7">
                    <div id="courselist">
                        <div class="mb-3 p-3 card topic-card rounded">
                            <div class="fw-bold mb-2" id="coursecount"><h3 class="h4 fw-semibold"><span class="badge fs-5 bg-gov-blue me-1"><?= $post_my_query->found_posts ?></span> courses found</h3></div>
