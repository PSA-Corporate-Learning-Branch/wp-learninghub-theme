    ...
    <div class="bg-secondary-subtle pt-4">
        <div class="container-lg p-lg-5 p-4 bg-light-subtle">
            ...
            <div class="d-lg-flex justify-content-center align-items-center gap-5 my-4">
                ...
                <div>
                    <div class="vstack gap-2 fw-bold">
                        <div><span class="badge rounded-pill bg-gov-blue p-2 me-3 mb-1"><i class="bi bi-person-fill fs-5"></i></span>Learner-centric</div>
                        <div><span class="badge rounded-pill bg-gov-purple p-2 me-3 mb-1"><i class="bi bi-award fs-5"></i></span>Enduring capabilities</div>
                        <div><span class="badge rounded-pill bg-gov-ltblue p-2 me-3 mb-1"><i class="bi bi-boxes fs-5"></i></span>Relationship building</div>
                        <div><span class="badge rounded-pill bg-gov-green p-2 me-3 mb-1"><i class="bi bi-briefcase fs-5"></i></span>Career paths</div>
                        <div><span class="badge rounded-pill bg-gov-blue p-2 me-3 mb-1"><i class="bi bi-person-wheelchair fs-5"></i></span>Accessible</div>
                        <div><span class="badge rounded-pill bg-gov-purple p-2 me-3 mb-1"><i class="bi bi-building-check fs-5"></i></span>Future ready</div>
                        <div><span class="badge rounded-pill bg-gov-ltblue p-2 me-3 mb-1"><i class="bi bi-laptop fs-5"></i></span>Just-in-time</div>
                        <div><span class="badge rounded-pill bg-gov-green p-2 me-3 mb-1"><i class="bi bi-list-check fs-5"></i></span>Skill building</div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>1. Place learners at the centre</h4>
                    <ul class="ms-3">
            ...
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>2. Align learning with business priorities and goals</h4>
                    <ul class="ms-3">
            ...
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>3. Make learning available and just-in-time</h4>
                    <ul class="ms-3">
            ...
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>4. Empower people to grow their career within the BC Public Service</h4>
                    <ul class="ms-3">
                        <li>Tie learning to career paths and career journeys that enable learners to grow their career within the BC Public Service</li>
            ...
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>5. Promote connectedness to others and the BC Public Service desired culture</h4>
                    <ul class="ms-3">
                        <li>Develop learning that enables learners to build social connections within the BC Public Service and enhance their network</li>
                        <li>Develop learning that enables learners to learn from their peers</li>
                        <li>Develop learning that promotes the desired culture within the BC Public Service</li>
                    </ul>
                </div>
            </div>
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>6. Anchor on established content and frameworks</h4>
                    <ul class="ms-3">
                        <li>Anchor learning content on existing corporate frameworks in the BC Public Service</li>
            ...
            <div class="d-flex mt-lg-4 align-content-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <h4>7. Encourage active reflection and application to role for learners</h4>
                    <ul class="ms-3">
