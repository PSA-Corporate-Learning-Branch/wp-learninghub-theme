...
/**
 * The template for displaying the CLDF
 *
...
<div id="content">
  ...
  <p>Current and aspiring people leaders are encouraged to assess leadership values, expectations, and competencies to develop and improve their leadership mastery through the four learning pathways.</p>
  
  <h2>Vision</h2>
  
  <p>The CLDF supports the vision of a future-focused BC Public Service, led by inspired, skilled, authentic leaders who model and embrace diversity within a shared set of leadership expectations, values, and competencies.</p>
  
  <p>It provides a consistent, government-wide approach to achieve that vision through people leader training and development.</p>
  
  <h2>Principles</h2>
  
  <p>Corporate leadership development is:</p>
  
  <ul>
  <li><strong>Accessible:</strong> Learning is available for the many, not the few</li>
  <li><strong>Aligned:</strong> Activities and supports will be aligned with our Public Service values and expectations and reinforce the one employer experience</li>
  <li><strong>Flexible:</strong> Meet leaders where they are on their learning journey, providing many avenues for learning to meet their needs</li>
  <li><strong>Forward thinking:</strong> Focused on the skills and competencies required now, and in the future, while also reflecting best practices in learning and development design</li>
  <li><strong>Inclusive:</strong> Embrace the diversity of leaders from various backgrounds</li>
  </ul>
  
  <h2>Qualities of a leader</h2>
  
  <p>This initiative seeks to build leaders who demonstrate:</p>
  
  <ul>
  <li>Professional, value-based, ethical and inclusive leadership</li>
  <li>Leadership, building, and managing of high-performing teams</li>
  <li>Commitment to service while enhancing public trust and confidence</li>
  <li>Pursuit and engagement in personal growth and self-reflection</li>
  <li>Compassion and empathy</li>
  <li>A strategic perspective, financial acumen, and comfort with calculated risk-taking</li>
