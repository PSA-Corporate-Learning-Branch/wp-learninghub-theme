...
<div id="content">
    <div class="d-flex p-4 p-md-5 align-items-center bg-gov-green bg-gradient" style="height: 12vh; min-height: 100px;">
        <div class="container-lg px-0 px-md-3 py-4 py-md-5">
            <h1 class="mb-0 text-white">Course Categorization</h1>
        </div>
    </div>
    <div class="bg-secondary-subtle">
        <div class="container-lg p-lg-5 p-4 bg-light-subtle">
            <h2>How is learning organized?</h2>
            <p class="mb-4">Three types of categorization help you find exactly what you're looking for: topic, audience, and delivery.</p>
            <p class="fs-6"> <span class="icon-svg baseline-svg">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path fill="currentColor" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" />
                    </svg>
                </span> <small>Select a heading to expand the category. Select a specific topic, audience or delivery method to open a list of filtered results.</small>
            </p>
            <div class="accordion" id="filterCategories">

                <div class="accordion-item mb-1">
                    <h4 class="accordion-header" id="topicsHeading">
                        <button class="accordion-button bg-gov-green py-2 px-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTopics" aria-expanded="false" aria-controls="collapseTopics">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h4 class="text-white mb-1">Topic</h4>
                ...
                <div class="accordion-item mb-1">
                    <h4 class="accordion-header" id="audienceHeading">
                        <button class="accordion-button bg-gov-green py-2 px-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAudience" aria-expanded="false" aria-controls="collapseAudience">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h4 class="text-white mb-1">Audience</h4>
                                    <p class="lh-sm fs-6  mb-1">Who is the learning for?</p>
                                </div>
                            </div>
                        </button>
                    </h4>
                ...
                <div class="accordion-item mb-1">
                    <h4 class="accordion-header" id="deliveryHeading">
                        <button class="accordion-button bg-gov-green py-2 px-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDelivery" aria-expanded="false" aria-controls="collapseDelivery">
                            <div class="d-flex">
                                <div class="icon-square flex-shrink-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="icon"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                ...
                                <div>
                                    <h4 class="text-white mb-1">Delivery Method</h4>
